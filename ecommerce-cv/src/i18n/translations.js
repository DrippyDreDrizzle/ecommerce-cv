...
export const translations = {
  en: {
    ...
    content: {
      ...
      specialSkillsHeader: 'Special Skills',
      specialSkills: [
  ...
  ja: {
    ...
    content: {
      ...
      skillStats: [
        ...
        { key: 'creativity', label: '創造力' },
        { key: 'drive', label: '推進力' },
        { key: 'adaptability', label: '適応力' },
        { key: 'intelligence', label: '知性' },
      ],
      specialSkillsHeader: '特殊スキル',
      specialSkills: [
        { name: 'フルファネル再構築', tag: 'スペシャル', desc: '壊れたチェックアウトを分解し、データに基づいて再構築する。' },
        { name: 'データ主導のピボット', tag: 'スペシャル', desc: '数字を読み取り、四半期を無駄にする前に方向転換する。' },
        { name: 'ゼロ・トゥ・ローンチ', tag: 'アルティメット', desc: '要件定義から公開まで、Shopifyストアを一人で作り上げる。', ultimate: true },
      ],
      record: [
